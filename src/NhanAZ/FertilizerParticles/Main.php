			...
			if ($item == 351) {
				if($event->getAction() === PlayerInteractEvent::RIGHT_CLICK_BLOCK) {
					do {
						$z1 = mt_rand(5, 20) / 10;
						$y1 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add(0.5, $y1, $z1);
						...
						$z2 = mt_rand(5, 20) / 10;
						$y2 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add($x1, $y2, $z2);
						$summon_particle = new HappyVillagerParticle($coordinates_particle);
						$block->getLevel()->addParticle($summon_particle);

						$x3 = mt_rand(-20, 5) / 10;
						$y3 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add($x3, $y3, 0.5);
						$summon_particle = new HappyVillagerParticle($coordinates_particle);
						$block->getLevel()->addParticle($summon_particle);
						...
						$z3 = mt_rand(-20, 5) / 10;
						$y4 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add($x4, $y4, $z3);
						$summon_particle = new HappyVillagerParticle($coordinates_particle);
						$block->getLevel()->addParticle($summon_particle);

						$z4 = mt_rand(-20, 5) / 10;
						$y5 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add(0.5, $y5, $z4);
						$summon_particle = new HappyVillagerParticle($coordinates_particle);
						$block->getLevel()->addParticle($summon_particle);
						...
						$z5 = mt_rand(-20, 5) / 10;
						$y6 = mt_rand(11, 21) / 10;
						$coordinates_particle = $block->add($x5, $y6, $z5);
						$summon_particle = new HappyVillagerParticle($coordinates_particle);
						$block->getLevel()->addParticle($summon_particle);
